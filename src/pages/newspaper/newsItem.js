...
import { Grid,Stack, Typography, Paper, TextField, TextareaAutosize } from '../../../node_modules/@mui/material/index';
import { createTheme, ThemeProvider, styled } from '@mui/material/styles';
import Batch from '../../components/newspaper/batch';
import EndBatch from '../../components/newspaper/endBatch';
...
const NewsItem = ({xs=12,sm=12,md=6,lg=6, ...props}) => {
  ...
  const saveDetailData = () => {
    // call api to save data can combine above calls
  }
  const deleteItem = () => {
  ...
  const value = "Election Result 2023: All About Karnataka Election Results Date And Coverage Online";
    ...
    return (
        ...
        <div>
                  ...
                  <StyledH2 contentEditable={isHeaderEdit}>
                    <Batch 
                    ...
                    /> 
                     {value}
                     {
                      isHeaderEdit && 
                      <EndBatch 
                    cancelClick={() => cancelHeaderEdit()} 
                    saveData={() => saveHeaderData()}/>
                     }
                    
                  </StyledH2>
                  <StyledP contentEditable={isDetailEdit}> 
                  <Batch 
                  handleEdit={() => handleDetailEdit()}
                  regenerateResponse={() => regenerateResponse()}
                  /> 
                  Workers arrange EVMs in a strong room in Bengaluru after Karnataka Assembly elections.Karnataka election result 2023 will
                  ...
                  fielded its candidates. Also there were some smaller parties in the fray in a few constituencies.Answer: The BJP had then emerged
                   ...
                   cent.Track Latest News and Karnataka Elections 2023  Coverage Live on NDTV.com and get news updates from India and around the world.
                   {
                      isDetailEdit && 
                      <EndBatch 
                   cancelClick={() => cancelDetailEdit()} 
